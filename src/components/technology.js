...
import existingtech from './../img/existingtech.jpg';
import spentwater from './../img/spentwater.jpg';
	...
	render() {
		return(
			<div className="technology-grid">
				...
				<Grid>
					<Cell col={12}>
						<p>In many parts of India, the municipal water supply is restricted to certain hours of the day, so families are already accustomed to storing water in large containers similar to ours. Thus, Sulis easily integrates into our users’ daily routines, enabling rapid cultural adoption.</p>
					</Cell>
				</Grid>
				<hr/>
				<Grid>
					...
					<Cell col={7}>
						<img src={existingtech} alt="existingtech" width="100%"/>
					</Cell>
				...
				<Grid>
					...
					<Cell col={7}>
						<img src={spentwater} alt="spentwater" width="100%"/>
					</Cell>
					<Cell col={5}>
						<br/>
